 ...
 *    C'est a dire que la valeur du type doit etre soit haut, bas, gauche, droite, aucune_orientation
 *
 *    Necessite:
...
/** Fonction de TEST orientation_etre_integre
*
*   Fais les test pour la fonction orientation_etre_integre
...
/** Fonction de TEST orientation_etre_integre_deplacement
*
*   Fais les test pour la fonction orientation_etre_integre_deplacement
*   Pour les cas suivant:
*   - haut
*   - bas
*   - gauche
...
/** Fonction de TEST orientation_inverser **/
...
/** Fonction de TEST orientation_correspondre_caractere
*
*   Fais les test pour la fonction orientation_etre_integre
*   Pour les cas suivant:
*   - ^
