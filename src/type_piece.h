...
/**
 * Fonction appel_test_type_piece :
 * *******************************
 * Appelle et lance toutes les fonctions de test de la classe 'type_piece'
 */
...
/** Fonction de TEST type_etre_integre
*
*   Fais les test pour la fonction type_etre_integre
*   Pour les cas suivant:
*   - elephant,rhinoceros,rocher et case_vide
*   - valeur de 4 à 100 ne correspondant à rien
*/
...
/** Fonction de TEST type_etre_animal
*
*   Fais les test pour la fonction type_etre_animal
*   Pour les cas suivant:
*   - elephant et rhinoceros
*   - rocher et case_vide
*
*/
...
/** Fonction de TEST type_nommer_nom_cours
*
*   Fais les test pour la fonction type_nommer_nom_cours
*   Pour les cas suivant:
*   - 'e' elephant
*   - 'r' rhinoceros
*   - 'RRR' rocher
...
/** Fonction de TEST type_correspondre_caractere_animal
*
*   Fais les test pour la fonction type_correspondre_caractere_animal
*   Pour les cas suivant:
*   - 'e' elephant
*   - 'r' rhinoceros
*/
