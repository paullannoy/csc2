...
/** Fonction de TEST jeu_verifier_type_piece_a_modifier
*
*   Fais les test pour la fonction jeu_verifier_type_piece_a_modifier
*   Pour les cas suivant:
*   - joueur = 0 elephant 1 1
*   - joueur = 1 rhino 4 2
*/
...
/** Fonction de TEST jeu_obtenir_type_animal_courant
*
*   Fais les test pour la fonction jeu_obtenir_type_animal_courant
*   Pour les cas suivant:
*   - joueur = 0
*   - joueur = 1
*/
